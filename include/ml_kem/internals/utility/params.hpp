...
// See table 2 of ML-KEM specification https://doi.org/10.6028/NIST.FIPS.203.
consteval bool
check_encrypt_params(const size_t k, const size_t eta1, const size_t eta2, const size_t du, const size_t dv)
{
  const bool flg0 = (k == 2) && (eta1 == 3) && (eta2 == 2) && (du == 10) && (dv == 4);
  const bool flg1 = (k == 3) && (eta1 == 2) && (eta2 == 2) && (du == 10) && (dv == 4);
  const bool flg2 = (k == 4) && (eta1 == 2) && (eta2 == 2) && (du == 11) && (dv == 5);
...
// See table 2 of ML-KEM specification https://doi.org/10.6028/NIST.FIPS.203.
consteval bool
check_encap_params(const size_t k, const size_t eta1, const size_t eta2, const size_t du, const size_t dv)
{
  return check_encrypt_params(k, eta1, eta2, du, dv);
}
...
// See table 2 of ML-KEM specification https://doi.org/10.6028/NIST.FIPS.203.
consteval bool
check_decap_params(const size_t k, const size_t eta1, const size_t eta2, const size_t du, const size_t dv)
{
  return check_encap_params(k, eta1, eta2, du, dv);
}
